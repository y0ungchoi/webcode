		...
		<div class="inner">
			<div class="sign">
				<%
					int m = 0;
					if (m == 0) {
						out.println("<button id='signUp' class='btn' onclick='location.href='join.html''>SignUp</button>");
						out.println("<button id='signIn' class='btn' onclick='location.href='login.html''>SignIn</button>");
					} else {
						out.println("<button id='mypage' class='btn' onclick='location.href='join.html''>Mypage</button>");
						out.println("<button id='signOut' class='btn' onclick='location.href='login.html''>SignOut</button>");
					}
				%>
			...
			<div class="rolling">
				<ul id="list">
					<%
						...
						Vector<MainVo> v = revdao.mainrank();
						for (int i = 0; i < v.size(); i++) {
							MainVo result = (MainVo) v.get(i);
							out.println("<li><a href ='#'>" + (i + 1) + ". " + result.getProd_nmk() + "</a></li>");
						}
					%>
				</ul>
			</div>
